...
> Le formulaire de contact post-test (F3/F6) utilise un lien `mailto:` qui
> ouvre directement le client mail du visiteur (Mail iOS, Gmail Android,
> etc.). Aucun SMTP côté serveur, aucune dépendance externe.
